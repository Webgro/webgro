 ...
 * does: the contact form (with AI follow-up questions via Anthropic),
 * the charity application form, the newsletter (Klaviyo), and consent-only
 * Google Analytics. If any of that changes (a Meta pixel, Hotjar, a CRM,
 * storing enquiries in a database such as Neon), this page has to be
 * updated to reflect it before launch.
 *
 ...
 */
/**
 * The wording of the privacy policy, kept out of the route tree so the page at
 * /privacy can render it through LegalDocument without importing itself.
 * extractLegal() reads the <LegalPageView> element this returns and re-dresses
 * its children in the redesign's markup, so the words below are the only copy
 * of the privacy policy on the site. Edit it here and the page follows.
 */
import {
  LegalPageView,
  LegalH2,
  ...
  return (
    ...
    >
      ...
      <LegalP>
        ...
        Lane, Bracknell, Berkshire, RG12 1RL.
      </LegalP>
      <LegalP>
      ...
      <LegalP>
        ...
        email address, optional phone number and company, the services
        you&rsquo;re interested in, your ballpark budget, and your answers
        to the form&rsquo;s questions. We use this information for one
        thing only: to reply to your enquiry and, if you want to work with
        us, to scope a project together.
      </LegalP>
      <LegalP>
        The contact form asks a few follow-up questions based on your
        earlier answers. To choose those questions, your answers are sent
        to Anthropic, whose AI model Claude suggests the next question.
        When you send the form, your answers and your company name (if you
        give one) are also sent to Anthropic to write a short summary for
        our team. Your name, email address and phone number are never sent
        to Anthropic. A person at Webgro reads every enquiry, and
      ...
      <LegalH3>Charity website applications</LegalH3>
      <LegalP>
        If you apply for a free charity website, we collect the details you
        give about the charity and its needs, and your name, role, email
        address and optional phone number. We use them to consider the
        application and to contact you about it.
      </LegalP>
      <LegalP>
        <strong>Lawful basis:</strong> legitimate interest (Article 6(1)(f)
        UK GDPR). You asked us to consider your application.
      </LegalP>
      ...
      <LegalP>
        When you submit a form on our site, Cloudflare Turnstile runs a
      ...
      <LegalUl>
        ...
        <li>
          <strong>Charity website applications:</strong> 12 months after
          last contact, then deleted, unless we go on to work together.
        </li>
        <li>
          <strong>Newsletter:</strong> until you unsubscribe or ask us to
          remove you.
        </li>
        <li>
      ...
      <LegalUl>
        ...
        <li>
          ...
          form submissions. Processes only the content of each
          submission and the recipient address. UK IDTA in place.
        </li>
        <li>
          <strong>Cloudflare Turnstile (US)</strong>: bot-protection
          challenge on our forms. Receives challenge metadata, not
          the content of your submission. UK IDTA in place.
        </li>
        <li>
          <strong>Anthropic (US)</strong>: the AI model behind the contact
          form&rsquo;s follow-up questions and enquiry summaries. Processes
          your answers to the form&rsquo;s questions and your company name,
          never your name, email address or phone number, and does not use
          them to train its models.
        </li>
        <li>
          <strong>Klaviyo (US)</strong>: newsletter signups and emails.
          Processes your email address and whether you open or click our
          emails.
        </li>
        <li>
