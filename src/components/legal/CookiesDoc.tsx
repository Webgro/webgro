 ...
 */
/**
 * The wording of the cookie policy, kept out of the route tree so the page at
 * /cookies can render it through LegalDocument without importing itself.
 ...
 * of the cookie policy on the site. Edit it here and the page follows.
 */
import {
  LegalPageView,
  LegalH2,
