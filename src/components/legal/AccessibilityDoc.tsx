 ...
 */
/**
 * The wording of the accessibility statement, kept out of the route tree so the page at
 * /accessibility can render it through LegalDocument without importing itself.
 ...
 * of the accessibility statement on the site. Edit it here and the page follows.
 */
import {
  LegalPageView,
  LegalH2,
